    ...
    return `
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-success" onclick="openSendMessageModal(${member.member_id}, '${member.member_name}', '${member.member_phone}', '${member.rsvp_status}', '${member.total}')">Invite</button>
                <button class="btn btn-danger btn-sm" onclick="openSendMessageModal(${member.member_id}, '${member.member_name}', '${member.member_phone}', '${member.rsvp_status}', '${member.total}')">call</button>
            </td>
        </tr>
    `;
}
...
window.openSendMessageModal = async function (id, memberName, memberPhone, status, total) {
    try {
        const response = await fetch(`${API_BASE_URL}/members/${id}`);
...
window.sendBoth = async function () {
    ...
    window.sendToAllMember = async function () {
        ...
        console.log({
            id, memberName, memberPhone, status, total,
            eventId, eventCategory, eventTitle, eventDateTime, eventVenue
        });
